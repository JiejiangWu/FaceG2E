...
class Controlnet_I2I(nn.Module):
    ...
    def img2img_single_step(self, text_embeddings, image, depth_mask, step, guidance_scale=100):
        # input:
        ...
        with torch.no_grad():
            prev_latents = self.encode_imgs(image)
    ...
    def forward(self, prompt, image, depth_mask, strength: float=0.8, num_inference_steps: int = 50,
        ...
        prompt_embeds = self.get_text_embeds(prompt,negative_prompt)
